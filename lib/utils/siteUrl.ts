...
// `foodtruckos.vercel.app` y uno `foodtruckos.com`, un dominio que todavía no
// es nuestro. El día que faltara la variable de entorno, los correos de aviso
...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://foodtruckos.vercel.app"
